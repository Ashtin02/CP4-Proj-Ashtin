//Used ChatGPT to get product Descriptions
const products = {
  iPhoneX: {
      name: "iPhoneX",
    ...
    "iPhone 13 Pro Max Case (Silicone)": {
    ...
    "Spigen Tough Armor Case for iPhone 13": {
    ...
    "iPhone 16 Pro": {
      ...
      "Privacy Screen Protector for iPhone 16 Pro": {
      ...
      "Tempered Glass Screen Protector for iPhone 16 Pro Max": {
